   ...
   0000                     424 	.ds 8
                            ...
                            447 ;--------------------------------------------------------
                            448 	.area XSEG    (XDATA)
   00E5                     449 _I2C_Write_dat_1_1:
   00E5                     450 	.ds 1
   00E6                     451 _I2C_Read_dat_1_1:
   00E6                     452 	.ds 1
                            453 ;--------------------------------------------------------
   ...
   17FE                     607 _I2C_Write:
                            608 ;	genReceive
   17FE E5 82               609 	mov	a,dpl
   1800 90 00 E5            610 	mov	dptr,#_I2C_Write_dat_1_1
   1803 F0                  611 	movx	@dptr,a
                            612 ;	i2c.c:154: for(i=0;i<8;i++)		 // loop 8 times to send 1-byte of data
                            613 ;	genAssign
   1804 7A 00               614 	mov	r2,#0x00
   1806                     615 00101$:
                            616 ;	genCmpLt
                            617 ;	genCmp
   1806 BA 08 00            618 	cjne	r2,#0x08,00110$
   1809                     619 00110$:
                            620 ;	genIfxJump
                            621 ;	Peephole 108.a	removed ljmp by inverse jump logic
   1809 50 1D               622 	jnc	00104$
                            623 ;	Peephole 300	removed redundant label 00111$
                            624 ;	i2c.c:156: P1_2 = dat & 0x80;    // Send Bit by Bit on SDA line
                            625 ;	genAssign
   180B 90 00 E5            626 	mov	dptr,#_I2C_Write_dat_1_1
   180E E0                  627 	movx	a,@dptr
                            628 ;	genGetHbit
   180F FB                  629 	mov	r3,a
                            630 ;	Peephole 105	removed redundant mov
   1810 33                  631 	rlc	a
   1811 92 92               632 	mov	_P1_2,c
                            633 ;	i2c.c:157: I2C_Clock();      	 // Generate Clock at SCL
                            634 ;	genCall
   1813 C0 02               635 	push	ar2
   1815 C0 03               636 	push	ar3
   1817 12 17 B5            637 	lcall	_I2C_Clock
   181A D0 03               638 	pop	ar3
   181C D0 02               639 	pop	ar2
                            640 ;	i2c.c:158: dat = dat<<1;
                            641 ;	genLeftShift
                            642 ;	genLeftShiftLiteral
                            643 ;	genlshOne
   181E EB                  644 	mov	a,r3
                            645 ;	Peephole 254	optimized left shift
   181F 2B                  646 	add	a,r3
                            647 ;	genAssign
   1820 FB                  648 	mov	r3,a
   1821 90 00 E5            649 	mov	dptr,#_I2C_Write_dat_1_1
                            650 ;	Peephole 100	removed redundant mov
   1824 F0                  651 	movx	@dptr,a
                            652 ;	i2c.c:154: for(i=0;i<8;i++)		 // loop 8 times to send 1-byte of data
                            653 ;	genPlus
                            654 ;     genPlusIncr
   1825 0A                  655 	inc	r2
                            656 ;	Peephole 112.b	changed ljmp to sjmp
   1826 80 DE               657 	sjmp	00101$
   1828                     658 00104$:
                            659 ;	i2c.c:160: P1_2 = 1;			     // Set SDA at last
                            660 ;	genAssign
   1828 D2 92               661 	setb	_P1_2
   ...
   182B                     674 _I2C_Read:
                            ...
                            676 ;	genAssign
   182B 90 00 E6            677 	mov	dptr,#_I2C_Read_dat_1_1
                            678 ;	Peephole 181	changed mov to clr
   182E E4                  679 	clr	a
   182F F0                  680 	movx	@dptr,a
                            681 ;	i2c.c:192: P1_2=1;			    //Make SDA as I/P
                            682 ;	genAssign
   1830 D2 92               683 	setb	_P1_2
                            684 ;	i2c.c:193: for(i=0;i<8;i++)		// loop 8times read 1-byte of data
                            685 ;	genAssign
   1832 7A 00               686 	mov	r2,#0x00
   1834                     687 00101$:
                            688 ;	genCmpLt
                            689 ;	genCmp
   1834 BA 08 00            690 	cjne	r2,#0x08,00110$
   1837                     691 00110$:
                            692 ;	genIfxJump
                            693 ;	Peephole 108.a	removed ljmp by inverse jump logic
   1837 50 35               694 	jnc	00104$
                            695 ;	Peephole 300	removed redundant label 00111$
                            696 ;	i2c.c:195: delay_us(1);
                            697 ;	genCall
                            698 ;	Peephole 182.b	used 16 bit load of dptr
   1839 90 00 01            699 	mov	dptr,#0x0001
   183C C0 02               700 	push	ar2
   183E 12 0D 81            701 	lcall	_delay_us
   1841 D0 02               702 	pop	ar2
                            703 ;	i2c.c:198: P3_4 = 1;			// Pull SCL High
                            704 ;	genAssign
   1843 D2 B4               705 	setb	_P3_4
                            706 ;	i2c.c:199: delay_us(1);
                            707 ;	genCall
                            708 ;	Peephole 182.b	used 16 bit load of dptr
   1845 90 00 01            709 	mov	dptr,#0x0001
   1848 C0 02               710 	push	ar2
   184A 12 0D 81            711 	lcall	_delay_us
   184D D0 02               712 	pop	ar2
                            713 ;	i2c.c:201: dat = dat<<1;		//dat is Shifted each time and
                            714 ;	genAssign
   184F 90 00 E6            715 	mov	dptr,#_I2C_Read_dat_1_1
   1852 E0                  716 	movx	a,@dptr
                            717 ;	genLeftShift
   ...
   1853 25 E0               723 	add	a,acc
   1855 FB                  724 	mov	r3,a
   1856 90 00 E6            725 	mov	dptr,#_I2C_Read_dat_1_1
                            726 ;	Peephole 100	removed redundant mov
   1859 F0                  727 	movx	@dptr,a
                            728 ;	i2c.c:202: dat = dat | P1_2;	//ORed with the received bit to pack into byte
                            729 ;	genAssign
   185A 90 00 E6            730 	mov	dptr,#_I2C_Read_dat_1_1
   185D E0                  731 	movx	a,@dptr
   185E FB                  732 	mov	r3,a
                            733 ;	genAssign
   185F E4                  734 	clr	a
   1860 A2 92               735 	mov	c,_P1_2
   1862 33                  736 	rlc	a
                            737 ;	genOr
   1863 FC                  738 	mov	r4,a
   1864 90 00 E6            739 	mov	dptr,#_I2C_Read_dat_1_1
                            740 ;	Peephole 177.d	removed redundant move
   1867 4B                  741 	orl	a,r3
   1868 F0                  742 	movx	@dptr,a
                            743 ;	i2c.c:204: P3_4 = 0;			// Clear SCL to complete the Clock
                            744 ;	genAssign
   1869 C2 B4               745 	clr	_P3_4
                            746 ;	i2c.c:193: for(i=0;i<8;i++)		// loop 8times read 1-byte of data
                            747 ;	genPlus
                            748 ;     genPlusIncr
   186B 0A                  749 	inc	r2
                            750 ;	Peephole 112.b	changed ljmp to sjmp
   186C 80 C6               751 	sjmp	00101$
   186E                     752 00104$:
                            753 ;	i2c.c:206: return dat;		         // Finally return the received Byte*
                            754 ;	genAssign
   186E 90 00 E6            755 	mov	dptr,#_I2C_Read_dat_1_1
   1871 E0                  756 	movx	a,@dptr
                            757 ;	genRet
                            758 ;	Peephole 234.a	loading dpl directly from a(ccumulator), r2 not set
   1872 F5 82               759 	mov	dpl,a
   ...
   1875                     771 _I2C_Ack:
                            ...
                            773 ;	genAssign
   1875 D2 92               774 	setb	_P1_2
                            775 ;	i2c.c:232: P3_4 = 1;			// Pull SCL High
                            776 ;	genAssign
   1877 D2 B4               777 	setb	_P3_4
                            778 ;	i2c.c:233: delay_us(1);
                            779 ;	genCall
                            780 ;	Peephole 182.b	used 16 bit load of dptr
   1879 90 00 01            781 	mov	dptr,#0x0001
   187C 12 0D 81            782 	lcall	_delay_us
                            783 ;	i2c.c:235: dat = P1_2;
                            784 ;	genAssign
   187F E4                  785 	clr	a
   1880 A2 92               786 	mov	c,_P1_2
   1882 33                  787 	rlc	a
   1883 FA                  788 	mov	r2,a
                            789 ;	i2c.c:237: P3_4 = 0;
                            790 ;	genAssign
   1884 C2 B4               791 	clr	_P3_4
                            792 ;	i2c.c:239: return dat;         // Return Ack status
                            793 ;	genRet
   1886 8A 82               794 	mov	dpl,r2
   ...
   1891                     825 _I2C_NoAck:
                            ...
                            827 ;	genAssign
   1891 D2 92               828 	setb	_P1_2
                            829 ;	i2c.c:267: I2C_Clock();	    // Generate the Clock
                            830 ;	genCall
   1893 12 17 B5            831 	lcall	_I2C_Clock
                            832 ;	i2c.c:268: P3_4 = 1;		// Set SCL */
                            833 ;	genAssign
   1896 D2 B4               834 	setb	_P3_4
