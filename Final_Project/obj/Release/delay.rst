                              ...
                              4 ; This file generated Tue Nov 22 19:02:48 2016
                              5 ;--------------------------------------------------------
                              6 	.module delay
   ...
   0000                     419 	.ds 8
                            ...
                            442 ;--------------------------------------------------------
                            443 	.area XSEG    (XDATA)
   0038                     444 _delay_us_us_1_1:
   0038                     445 	.ds 2
   003A                     446 _delay_ms_ms_1_1:
   003A                     447 	.ds 2
   003C                     448 _delay_sec_sec_1_1:
   003C                     449 	.ds 1
                            450 ;--------------------------------------------------------
   ...
   0D81                     489 _delay_us:
                    ...
                    0001    497 	ar1 = 0x01
                            498 ;	genReceive
   0D81 AA 83               499 	mov	r2,dph
   0D83 E5 82               500 	mov	a,dpl
   0D85 90 00 38            501 	mov	dptr,#_delay_us_us_1_1
   0D88 F0                  502 	movx	@dptr,a
   0D89 A3                  503 	inc	dptr
   0D8A EA                  504 	mov	a,r2
   0D8B F0                  505 	movx	@dptr,a
                            506 ;	delay.c:14: while(us!=0)
                            507 ;	genAssign
   0D8C 90 00 38            508 	mov	dptr,#_delay_us_us_1_1
   0D8F E0                  509 	movx	a,@dptr
   0D90 FA                  510 	mov	r2,a
   0D91 A3                  511 	inc	dptr
   0D92 E0                  512 	movx	a,@dptr
   0D93 FB                  513 	mov	r3,a
   0D94                     514 00101$:
                            515 ;	genCmpEq
                            516 ;	gencjneshort
   0D94 BA 00 05            517 	cjne	r2,#0x00,00109$
   0D97 BB 00 02            518 	cjne	r3,#0x00,00109$
                            519 ;	Peephole 112.b	changed ljmp to sjmp
   0D9A 80 0F               520 	sjmp	00108$
   0D9C                     521 00109$:
                            522 ;	delay.c:16: us--;
                            523 ;	genMinus
                            524 ;	genMinusDec
   0D9C 1A                  525 	dec	r2
   0D9D BA FF 01            526 	cjne	r2,#0xff,00110$
   0DA0 1B                  527 	dec	r3
   0DA1                     528 00110$:
                            529 ;	genAssign
   0DA1 90 00 38            530 	mov	dptr,#_delay_us_us_1_1
   0DA4 EA                  531 	mov	a,r2
   0DA5 F0                  532 	movx	@dptr,a
   0DA6 A3                  533 	inc	dptr
   0DA7 EB                  534 	mov	a,r3
   0DA8 F0                  535 	movx	@dptr,a
                            536 ;	Peephole 112.b	changed ljmp to sjmp
   0DA9 80 E9               537 	sjmp	00101$
   0DAB                     538 00108$:
                            539 ;	genAssign
   0DAB 90 00 38            540 	mov	dptr,#_delay_us_us_1_1
   0DAE EA                  541 	mov	a,r2
   0DAF F0                  542 	movx	@dptr,a
   0DB0 A3                  543 	inc	dptr
   0DB1 EB                  544 	mov	a,r3
   0DB2 F0                  545 	movx	@dptr,a
   ...
   0DB4                     557 _delay_ms:
                            558 ;	genReceive
   0DB4 AA 83               559 	mov	r2,dph
   0DB6 E5 82               560 	mov	a,dpl
   0DB8 90 00 3A            561 	mov	dptr,#_delay_ms_ms_1_1
   0DBB F0                  562 	movx	@dptr,a
   0DBC A3                  563 	inc	dptr
   0DBD EA                  564 	mov	a,r2
   0DBE F0                  565 	movx	@dptr,a
                            566 ;	delay.c:25: while(ms!=0)
                            567 ;	genAssign
   0DBF 90 00 3A            568 	mov	dptr,#_delay_ms_ms_1_1
   0DC2 E0                  569 	movx	a,@dptr
   0DC3 FA                  570 	mov	r2,a
   0DC4 A3                  571 	inc	dptr
   0DC5 E0                  572 	movx	a,@dptr
   0DC6 FB                  573 	mov	r3,a
   0DC7                     574 00101$:
                            575 ;	genCmpEq
                            576 ;	gencjneshort
   0DC7 BA 00 05            577 	cjne	r2,#0x00,00109$
   0DCA BB 00 02            578 	cjne	r3,#0x00,00109$
                            579 ;	Peephole 112.b	changed ljmp to sjmp
   0DCD 80 1D               580 	sjmp	00108$
   0DCF                     581 00109$:
                            582 ;	delay.c:27: delay_us(112);	 //delay_us is called to generate 1ms delay
                            583 ;	genCall
                            584 ;	Peephole 182.b	used 16 bit load of dptr
   0DCF 90 00 70            585 	mov	dptr,#0x0070
   0DD2 C0 02               586 	push	ar2
   0DD4 C0 03               587 	push	ar3
   0DD6 12 0D 81            588 	lcall	_delay_us
   0DD9 D0 03               589 	pop	ar3
   0DDB D0 02               590 	pop	ar2
                            591 ;	delay.c:28: ms--;
                            592 ;	genMinus
                            593 ;	genMinusDec
   0DDD 1A                  594 	dec	r2
   0DDE BA FF 01            595 	cjne	r2,#0xff,00110$
   0DE1 1B                  596 	dec	r3
   0DE2                     597 00110$:
                            598 ;	genAssign
   0DE2 90 00 3A            599 	mov	dptr,#_delay_ms_ms_1_1
   0DE5 EA                  600 	mov	a,r2
   0DE6 F0                  601 	movx	@dptr,a
   0DE7 A3                  602 	inc	dptr
   0DE8 EB                  603 	mov	a,r3
   0DE9 F0                  604 	movx	@dptr,a
                            605 ;	Peephole 112.b	changed ljmp to sjmp
   0DEA 80 DB               606 	sjmp	00101$
   0DEC                     607 00108$:
                            608 ;	genAssign
   0DEC 90 00 3A            609 	mov	dptr,#_delay_ms_ms_1_1
   0DEF EA                  610 	mov	a,r2
   0DF0 F0                  611 	movx	@dptr,a
   0DF1 A3                  612 	inc	dptr
   0DF2 EB                  613 	mov	a,r3
   0DF3 F0                  614 	movx	@dptr,a
   ...
   0DF5                     626 _delay_sec:
                            627 ;	genReceive
   0DF5 E5 82               628 	mov	a,dpl
   0DF7 90 00 3C            629 	mov	dptr,#_delay_sec_sec_1_1
   0DFA F0                  630 	movx	@dptr,a
                            631 ;	delay.c:44: while(sec!=0)
                            632 ;	genAssign
   0DFB 90 00 3C            633 	mov	dptr,#_delay_sec_sec_1_1
   0DFE E0                  634 	movx	a,@dptr
   0DFF FA                  635 	mov	r2,a
   0E00                     636 00101$:
                            637 ;	genCmpEq
                            638 ;	gencjneshort
   0E00 BA 00 02            639 	cjne	r2,#0x00,00109$
                            640 ;	Peephole 112.b	changed ljmp to sjmp
   0E03 80 12               641 	sjmp	00108$
   0E05                     642 00109$:
                            643 ;	delay.c:46: delay_ms(1000);	//delay_ms is called to generate 1sec delay
                            644 ;	genCall
                            645 ;	Peephole 182.b	used 16 bit load of dptr
   0E05 90 03 E8            646 	mov	dptr,#0x03E8
   0E08 C0 02               647 	push	ar2
   0E0A 12 0D B4            648 	lcall	_delay_ms
   0E0D D0 02               649 	pop	ar2
                            650 ;	delay.c:47: sec--;
                            651 ;	genMinus
                            652 ;	genMinusDec
   0E0F 1A                  653 	dec	r2
                            654 ;	genAssign
   0E10 90 00 3C            655 	mov	dptr,#_delay_sec_sec_1_1
   0E13 EA                  656 	mov	a,r2
   0E14 F0                  657 	movx	@dptr,a
                            658 ;	Peephole 112.b	changed ljmp to sjmp
   0E15 80 E9               659 	sjmp	00101$
   0E17                     660 00108$:
                            661 ;	genAssign
   0E17 90 00 3C            662 	mov	dptr,#_delay_sec_sec_1_1
   0E1A EA                  663 	mov	a,r2
   0E1B F0                  664 	movx	@dptr,a
