                              ...
                              4 ; This file generated Mon Dec 05 02:44:19 2016
                              5 ;--------------------------------------------------------
                              6 	.module spi
   ...
   0000                     418 	.ds 8
                            ...
                            441 ;--------------------------------------------------------
                            442 	.area XSEG    (XDATA)
   05CF                     443 _spi_write_spi_data_1_1:
   05CF                     444 	.ds 1
                            445 ;--------------------------------------------------------
                            ...
                            474 	.area CSEG    (CODE)
                            475 ;------------------------------------------------------------
                            476 ;Allocation info for local variables in function 'spi_init'
                            477 ;------------------------------------------------------------
                            478 ;------------------------------------------------------------
                            479 ;	spi.c:22: void spi_init()
                            480 ;	-----------------------------------------
                            481 ;	 function spi_init
                            482 ;	-----------------------------------------
   3666                     483 _spi_init:
                    0002    484 	ar2 = 0x02
                    0003    485 	ar3 = 0x03
                    ...
                    0000    490 	ar0 = 0x00
                    0001    491 	ar1 = 0x01
                            492 ;	spi.c:24: SPCON = 0x33;
                            493 ;	genAssign
   3666 75 C3 33            494 	mov	_SPCON,#0x33
                            495 ;	spi.c:25: SPCON |= 0x40;
                            496 ;	genOr
   3669 43 C3 40            497 	orl	_SPCON,#0x40
                            498 ;	Peephole 300	removed redundant label 00101$
   366C 22                  499 	ret
                            500 ;------------------------------------------------------------
                            501 ;Allocation info for local variables in function 'spi_write'
                            502 ;------------------------------------------------------------
                            503 ;spi_data                  Allocated with name '_spi_write_spi_data_1_1'
                            504 ;------------------------------------------------------------
                            505 ;	spi.c:30: char spi_write(unsigned char spi_data)
                            506 ;	-----------------------------------------
                            507 ;	 function spi_write
                            508 ;	-----------------------------------------
   366D                     509 _spi_write:
                            510 ;	genReceive
   366D E5 82               511 	mov	a,dpl
   366F 90 05 CF            512 	mov	dptr,#_spi_write_spi_data_1_1
   3672 F0                  513 	movx	@dptr,a
                            514 ;	spi.c:33: SPDAT = spi_data;
                            515 ;	genAssign
   3673 90 05 CF            516 	mov	dptr,#_spi_write_spi_data_1_1
   3676 E0                  517 	movx	a,@dptr
   3677 F5 C5               518 	mov	_SPDAT,a
                            519 ;	spi.c:34: while(!(SPSTA & 0x80) );
   3679                     520 00101$:
                            521 ;	genAnd
   3679 E5 C4               522 	mov	a,_SPSTA
                            523 ;	genIfxJump
                            524 ;	Peephole 108.d	removed ljmp by inverse jump logic
   367B 30 E7 FB            525 	jnb	acc.7,00101$
                            526 ;	Peephole 300	removed redundant label 00108$
                            527 ;	spi.c:35: return SPDAT;
                            528 ;	genAssign
   367E AA C5               529 	mov	r2,_SPDAT
                            530 ;	genRet
   3680 8A 82               531 	mov	dpl,r2
                            532 ;	Peephole 300	removed redundant label 00104$
   3682 22                  533 	ret
                            534 	.area CSEG    (CODE)
                            535 	.area CONST   (CODE)
                            536 	.area XINIT   (CODE)
