                              ...
                              4 ; This file generated Sat Dec 03 05:18:11 2016
                              5 ;--------------------------------------------------------
                              6 	.module log
                            ...
                            206 	.globl _SP
                            207 	.globl _P0
                            208 	.globl _sd_log_data
                            209 	.globl _updated_location
                            210 	.globl _log_sd
                            211 ;--------------------------------------------------------
   ...
   0000                     419 	.ds 8
                            ...
                            442 ;--------------------------------------------------------
                            443 	.area XSEG    (XDATA)
   012C                     444 _updated_location::
   012C                     445 	.ds 2
   012E                     446 _sd_log_data::
   012E                     447 	.ds 512
                            448 ;--------------------------------------------------------
                            ...
                            477 	.area CSEG    (CODE)
                            478 ;------------------------------------------------------------
                            479 ;Allocation info for local variables in function 'log_sd'
                            480 ;------------------------------------------------------------
                            481 ;log_data                  Allocated with name '_log_sd_log_data_1_1'
                            482 ;------------------------------------------------------------
                            483 ;	log.c:27: void log_sd(char *log_data)
                            484 ;	-----------------------------------------
                            485 ;	 function log_sd
                            486 ;	-----------------------------------------
   2071                     487 _log_sd:
                    ...
                    0001    495 	ar1 = 0x01
                            496 ;	log.c:30: }
                            497 ;	Peephole 300	removed redundant label 00101$
   2071 22                  498 	ret
                            499 	.area CSEG    (CODE)
                            500 	.area CONST   (CODE)
                            501 	.area XINIT   (CODE)
