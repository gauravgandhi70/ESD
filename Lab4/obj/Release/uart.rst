   ...
   2B87                     485 _putchar:
                    ...
                    0001    493 	ar1 = 0x01
                            494 ;	genReceive
   2B87 E5 82               495 	mov	a,dpl
   2B89 90 00 D3            496 	mov	dptr,#_putchar_c_1_1
   2B8C F0                  497 	movx	@dptr,a
   ...
   2B8D 30 99 FD            503 	jnb	_TI,00101$
                            504 ;	Peephole 300	removed redundant label 00108$
                            505 ;	uart.c:17: SBUF = c;
                            506 ;	genAssign
   2B90 90 00 D3            507 	mov	dptr,#_putchar_c_1_1
   2B93 E0                  508 	movx	a,@dptr
   2B94 F5 99               509 	mov	_SBUF,a
                            510 ;	uart.c:18: TI = 0;
                            511 ;	genAssign
   2B96 C2 99               512 	clr	_TI
   ...
   2B99 10 98 02            532 	jbc	_RI,00108$
   2B9C 80 FB               533 	sjmp	00101$
   2B9E                     534 00108$:
                            535 ;	uart.c:27: WDTPRG |=0x07;WDTRST = 0x01E;WDTRST = 0x0E1;
                            536 ;	genOr
   2B9E 43 A7 07            537 	orl	_WDTPRG,#0x07
                            538 ;	genAssign
   2BA1 75 A6 1E            539 	mov	_WDTRST,#0x1E
                            540 ;	genAssign
   2BA4 75 A6 E1            541 	mov	_WDTRST,#0xE1
                            542 ;	uart.c:28: return SBUF;
                            543 ;	genAssign
   2BA7 AA 99               544 	mov	r2,_SBUF
                            545 ;	genRet
   2BA9 8A 82               546 	mov	dpl,r2
