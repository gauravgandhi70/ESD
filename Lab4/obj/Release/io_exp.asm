...
;--------------------------------------------------------
	...
	.globl _sec
	.globl _ms
	.globl _IOEX_WriteByte
	.globl _IOEX_ReadByte
	.globl _io_cnt
	.globl _io_exp_dir
;--------------------------------------------------------
...
_mi::
	.ds 1
_IOEX_WriteByte_ioex_Data_1_1:
	.ds 1
_io_cnt_io_exp_counter_1_1:
	.ds 2
_io_exp_dir_c_1_1:
	.ds 3
_io_exp_dir_io_status_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'IOEX_WriteByte'
;------------------------------------------------------------
...
;
;------------------------------------------------------------
;Allocation info for local variables in function 'IOEX_ReadByte'
;------------------------------------------------------------
...
;	Peephole 300	removed redundant label 00101$
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'io_cnt'
;------------------------------------------------------------
...
;	Peephole 300	removed redundant label 00101$
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'io_exp_dir'
;------------------------------------------------------------
;sloc0                     Allocated with name '_io_exp_dir_sloc0_1_0'
;c                         Allocated with name '_io_exp_dir_c_1_1'
;io_status                 Allocated with name '_io_exp_dir_io_status_1_1'
...
__str_0:
	...
	.db 0x0D
	.db 0x09
	.ascii " Select pin number from 0 to 7: "
	.db 0x00
__str_1:
	.db 0x0A
	.db 0x0A
