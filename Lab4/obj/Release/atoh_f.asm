...
; This file generated Thu Nov 10 20:32:48 2016
;--------------------------------------------------------
	.module atoh_f
...
;	Peephole 236.b	used r3 instead of ar3
	...
	ljmp	00117$
00116$:
;	atoh_f.c:34: else if(*(c)>=97 && *(c)<=102)
;	genAssign
	mov	dptr,#_atoh_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	Peephole 236.b	used r5 instead of ar5
	...
	ljmp	00129$
00128$:
;	atoh_f.c:55: else if(*(c)>=97 && *(c)<=102)
;	genAssign
	mov	dptr,#_atoh_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;------------------------------------------------------------
;	atoh_f.c:72: int atoh_data(char *c)
;	-----------------------------------------
;	 function atoh_data
;	-----------------------------------------
_atoh_data:
...
;	Peephole 236.b	used r3 instead of ar3
	...
	ljmp	00113$
00112$:
;	atoh_f.c:86: else if(*(c)>=97 && *(c)<=102)
;	genAssign
	mov	dptr,#_atoh_data_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	Peephole 236.b	used r5 instead of ar5
	...
	ljmp	00125$
00124$:
;	atoh_f.c:107: else if(*(c)>=97 && *(c)<=102)
;	genAssign
	mov	dptr,#_atoh_data_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00125$
00120$:
;	atoh_f.c:111: else if(*(c)>=65 && *(c)<=70)
;	genAssign
	mov	dptr,#_atoh_data_c_1_1
	movx	a,@dptr
	mov	r2,a
