...
; This file generated Thu Nov 10 13:19:57 2016
;--------------------------------------------------------
	.module main
...
;	-----------------------------------------
_hex_dump:
;	main.c:216: unsigned int st_addr,st_page, end_addr,end_page,flag=0,i,aaa,j=0;
;	genAssign
...
;	Peephole 182.a	used 16 bit load of DPTR
	...
	mov	r3,dph
;	genAssign
	mov	dptr,#_hex_dump_st_page_1_1
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
...
;	genIfxJump
	...
	ljmp	00129$
00181$:
;	main.c:284: aaa = 256*(st_page-1)+st_addr;
;	genMinus
;	genMinusDec
	dec	r2
	cjne	r2,#0xff,00182$
...
;	genAssign
	...
	inc	dptr
	movx	@dptr,a
;	main.c:294: seq_read(st_addr,st_page-1,16,r);
;	genAssign
	mov	dptr,#_hex_dump_st_addr_1_1
	movx	a,@dptr
	mov	r0,a
...
;	genIpop
	...
	pop	ar4
	ljmp	00141$
;	Peephole 259.b	removed redundant label 00145$ and ret
;
;------------------------------------------------------------
...
;------------------------------------------------------------
;	main.c:372: void DDRAM_dump()
;	-----------------------------------------
;	 function DDRAM_dump
;	-----------------------------------------
_DDRAM_dump:
;	main.c:376: lcdputcmd(0x80);
;	genCall
	mov	dpl,#0x80
	lcall	_lcdputcmd
;	main.c:377: for(i=0;i<64;i++)
;	genAssign
	mov	r2,#0x00
;	genAssign
	mov	r3,#0x00
...
;	genCall
	mov	dpl,#0x0A
	lcall	_putchar
;	main.c:399: lcdputcmd(0x40);
;	genCall
	mov	dpl,#0x40
	lcall	_lcdputcmd
;	main.c:400: for(i=0;i<32;i++)
;	genAssign
	mov	r2,#0x20
	mov	r3,#0x00
00103$:
;	main.c:402: temp = lcdread();
;	genCall
	push	ar2
	push	ar3
	lcall	_lcdread
