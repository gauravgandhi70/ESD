...
;------------------------------------------------------------
;	eeprom.c:31: void seq_read(unsigned char st_addr,unsigned char st_page, int bytes,unsigned char *eeprom_Data)
;	-----------------------------------------
;	 function seq_read
;	-----------------------------------------
_seq_read:
...
;	genReceive
	...
	movx	@dptr,a
;	eeprom.c:35: I2C_Start();               // Start i2c communication
;	genCall
	lcall	_I2C_Start
;	eeprom.c:36: I2C_Write(EEPROM_ID|(st_page<<1));	   // connect to AT2404(write) by sending its ID on I2c Bus
;	genAssign
...
;	genCall
	...
	lcall	_I2C_Ack
	pop	ar2
;	eeprom.c:38: I2C_Write(st_addr); // Select the Specified EEPROM address of AT2404
;	genAssign
	mov	dptr,#_seq_read_st_addr_1_1
	movx	a,@dptr
;	genCall
...
;	genCall
	...
	lcall	_I2C_Start
	pop	ar2
;	eeprom.c:42: I2C_Write(0xA1|(st_page<<1));           // connect to AT2404(read) by sending its ID on I2c Bus
;	genOr
	orl	ar2,#0xA1
;	genCall
	mov	dpl,r2
...
;	eeprom.c:46: *eeprom_Data= I2C_Read();  // Read the data from specified address
;	genCall
	push	ar2
	push	ar3
	push	ar4
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00101$
00104$:
;	eeprom.c:51: eeprom_Data[bytes]= I2C_Read();  // Read the data from specified address
;	genPlus
...
;	genGenPointerSet
	...
	mov	a,r4
	lcall	__gptrput
;	eeprom.c:52: I2C_NoAck();
;	genCall
	lcall	_I2C_NoAck
;	eeprom.c:53: I2C_Stop();
;	genCall
...
;------------------------------------------------------------
;	eeprom.c:70: void EEPROM_WriteByte(unsigned char eeprom_Address, unsigned char eeprom_Data, unsigned char Page_Number)
;	-----------------------------------------
...
;	genReceive
	...
	movx	@dptr,a
;	eeprom.c:73: I2C_Start();               // Start i2c communication
;	genCall
	lcall	_I2C_Start
;	eeprom.c:74: I2C_Write(EEPROM_ID|(Page_Number<<1));	   // connect to AT2404 by sending its ID on I2c Bus
;	genAssign
...
;	genCall
	lcall	_I2C_Ack
;	eeprom.c:76: I2C_Write(eeprom_Address); // Select the Specified EEPROM address of AT2404
;	genAssign
	mov	dptr,#_EEPROM_WriteByte_eeprom_Address_1_1
	movx	a,@dptr
;	genCall
...
;	genCall
	lcall	_I2C_Ack
;	eeprom.c:78: I2C_Write(eeprom_Data);    // Write the data at specified address
;	genAssign
...
;	genCall
	lcall	_I2C_Ack
;	eeprom.c:80: I2C_Stop();           	   // Stop i2c communication after Writing the data
;	genCall
	lcall	_I2C_Stop
;	eeprom.c:81: delay_ms(5);               // Write operation takes max 5ms, refer At2404 datasheet
;	genCall
...
;------------------------------------------------------------
;	eeprom.c:103: unsigned char EEPROM_ReadByte(unsigned char eeprom_Address,unsigned char Page_Number)
;	-----------------------------------------
...
;	genReceive
	...
	movx	@dptr,a
;	eeprom.c:107: I2C_Start();               // Start i2c communication
;	genCall
	lcall	_I2C_Start
;	eeprom.c:108: I2C_Write(EEPROM_ID|(Page_Number<<1));	   // connect to AT2404(write) by sending its ID on I2c Bus
;	genAssign
...
;	Peephole 244.c	loading dpl from a instead of r3
	...
	lcall	_I2C_Write
	pop	ar2
;	eeprom.c:109: I2C_Ack();
;	genCall
	push	ar2
	lcall	_I2C_Ack
	pop	ar2
;	eeprom.c:110: I2C_Write(eeprom_Address); // Select the Specified EEPROM address of AT2404
;	genAssign
	mov	dptr,#_EEPROM_ReadByte_eeprom_Address_1_1
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r3
	...
	lcall	_I2C_Write
	pop	ar2
;	eeprom.c:111: I2C_Ack();
;	genCall
	push	ar2
	lcall	_I2C_Ack
	pop	ar2
;	eeprom.c:113: I2C_Start();		       // Start i2c communication
;	genCall
	push	ar2
	lcall	_I2C_Start
	pop	ar2
;	eeprom.c:114: I2C_Write(0xA1|(Page_Number<<1));           // connect to AT2404(read) by sending its ID on I2c Bus
;	genOr
	orl	ar2,#0xA1
;	genCall
	mov	dpl,r2
...
;	genCall
	lcall	_I2C_Ack
;	eeprom.c:116: eeprom_Data = I2C_Read();  // Read the data from specified address
;	genCall
	lcall	_I2C_Read
	mov	r2,dpl
;	eeprom.c:117: I2C_NoAck();
;	genCall
	push	ar2
	lcall	_I2C_NoAck
	pop	ar2
;	eeprom.c:118: I2C_Stop();		           // Stop i2c communication after Reading the data
;	genCall
	push	ar2
	lcall	_I2C_Stop
	pop	ar2
;	eeprom.c:119: delay_us(10);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x000A
	push	ar2
	lcall	_delay_us
	pop	ar2
;	eeprom.c:120: return eeprom_Data;          // Return the Read data
;	genRet
	mov	dpl,r2
